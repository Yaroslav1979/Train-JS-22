...
const maxMessage = max.dispatchMessage("Hello!"); // Виведе: Відправлено SMS: [Max]: Hello!
SMSCommunicator.transmit(maxMessage); 
// Linda відправляє повідомлення через Email.
const lindaMessage = linda.dispatchMessage("Hello!"); // Виведе: Відправлено Email: [Linda]: Hello!
EmailCommunicator.transmit(lindaMessage);